FROM nvidia/cuda:11.2.0-devel as builder
...
#       COPY command.
RUN apt-get update && DEBIAN_FRONTEND="noninteractive" TZ="Europe/Paris" && apt-get install -y --no-install-recommends software-properties-common && \
